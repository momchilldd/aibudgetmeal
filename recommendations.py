...
# Convert meal names to embeddings
...
def recommend_meal(preference, budget):
    ...
    # Search for the closest meal in the vector database
    ...
    # Check if there are any actual meals depending on our search
